...
{
	global $plugin_debug, $gDb, $gValidLogin, $gCurrentUser, $gCurrentOrganization, $gProfileFields, $g_tbl_praefix, $plg_excluded_categories, $plg_excluded_roles;
	...
	if ($authorizedUser)
	{
		...
		$sql = $sql."	INNER JOIN ".$g_tbl_praefix."_roles ON mem_rol_id = rol_id ";
		$sql = $sql."	INNER JOIN ".$g_tbl_praefix."_categories ON rol_cat_id = cat_id ";
